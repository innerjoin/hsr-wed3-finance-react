            ...
            <Grid container>
                <Grid.Column>
                    <Segment raised>
                        ...
                        <Form>
                            <h2>Login</h2>
                            <FormFieldWithValidation fluid onChange={this.handleLoginChanged} ref="login"
                                                     validations={this.loginValidations} label='Login'
                                                     value={this.state.login}/>
                            <FormFieldWithValidation fluid onChange={this.handlePasswordChanged} ref="password"
